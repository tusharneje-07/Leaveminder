...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="hod-home.php">Home</a>
                        </li>
                        <li class="nav-item">
    ...
    <div class="container col-xxl-8 px-4 py-5 mt-400 maincontent">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold lh-1 mb-3">Welcome HOD to <span
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a class="btn btn-primary btn-lg px-4 me-md-2" href="hod-pending-leave.php">Pending Permissions</a>
                    <a class="btn btn-outline-success btn-lg px-4" href="hod-leave-register.php">Leave Register</a>
                </div>
            </div>
        </div>
    </div>
